namespace TriangulationDelone
{
    ...
    public class Mesh
    {
        ...
        public void Draw(MeshBuilder meshBuilder)
        {
            ...
            {
                var point1 = new Point3D(facet.A.X, facet.A.Y, facet.A.Z);
                var point2 = new Point3D(facet.B.X, facet.B.Y, facet.B.Z);
                var point3 = new Point3D(facet.C.X, facet.C.Y, facet.C.Z);
